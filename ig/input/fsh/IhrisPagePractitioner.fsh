...
* extension[section][7].extension[resource].extension[column][0].extension[header].valueString = "Degree"
* extension[section][7].extension[resource].extension[column][0].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-education-history').extension.where(url='degree').valueReference"
* extension[section][7].extension[resource].extension[column][1].extension[header].valueString = "Specialization"
* extension[section][7].extension[resource].extension[column][1].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-education-history').extension.where(url='specialization').valueCoding"
* extension[section][7].extension[resource].extension[column][2].extension[header].valueString = "Institution"
* extension[section][7].extension[resource].extension[column][2].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-education-history').extension.where(url='institution').valueString"
* extension[section][7].extension[resource].extension[column][3].extension[header].valueString = "Location"
* extension[section][7].extension[resource].extension[column][3].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-education-history').extension.where(url='location').valueString"
* extension[section][7].extension[resource].extension[column][4].extension[header].valueString = "Year"
* extension[section][7].extension[resource].extension[column][4].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-education-history').extension.where(url='year').valueDate"
...
* extension[section][7].extension[resource].extension[action][0].extension[link].valueString = "/questionnaire/ihris-education-history/education-history?practitioner=FHIRID"
...
* extension[section][7].extension[resource].extension[action][0].extension[task].valueId = "ihris-task-add-education"
* extension[section][7].extension[resource].extension[action][1].extension[link].valueString = "/resource/view/education-history/ITEMID"
...
* extension[section][7].extension[resource].extension[action][2].extension[link].valueString = "/questionnaire/ihris-education-history/education-history/ITEMID?practitioner=FHIRID"
...
* extension[section][7].extension[resource].extension[action][2].extension[task].valueId = "ihris-task-edit-education"
...
* extension[section][13].extension[title].valueString = "Situation Information"
* extension[section][13].extension[description].valueString = "Situation Information for the Person"
* extension[section][13].extension[name].valueString = "situation"
* extension[section][13].extension[resource].extension[resource].valueReference = Reference(StructureDefinition/situation-profile)
...
* extension[section][13].extension[resource].extension[column][0].extension[header].valueString = "Agent Status"
* extension[section][13].extension[resource].extension[column][0].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/agent-status').valueCoding"
* extension[section][13].extension[resource].extension[column][1].extension[header].valueString = "Qualification"
* extension[section][13].extension[resource].extension[column][1].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/qualification').valueCoding"
* extension[section][13].extension[resource].extension[column][2].extension[header].valueString = "Function"
* extension[section][13].extension[resource].extension[column][2].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/function').valueCoding"
* extension[section][13].extension[resource].extension[column][3].extension[header].valueString = "Level"
* extension[section][13].extension[resource].extension[column][3].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/level').valueCoding"
* extension[section][13].extension[resource].extension[column][4].extension[header].valueString = "Study Level"
* extension[section][13].extension[resource].extension[column][4].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/study-level').valueCoding"
...
* extension[section][13].extension[resource].extension[action][0].extension[link].valueString = "/questionnaire/situation/situation?practitioner=FHIRID"
* extension[section][13].extension[resource].extension[action][0].extension[text].valueString = "Add Situation"
...
* extension[section][13].extension[resource].extension[action][0].extension[task].valueId = "ihris-task-add-situation"
* extension[section][13].extension[resource].extension[action][1].extension[link].valueString = "/questionnaire/situation/situation/ITEMID?practitioner=FHIRID"
...
* extension[section][13].extension[resource].extension[action][1].extension[task].valueId = "ihris-task-edit-situation"
* extension[section][14].extension[title].valueString = "Classification Information"
* extension[section][14].extension[description].valueString = "Classification Information for the Person"
* extension[section][14].extension[name].valueString = "classification"
* extension[section][14].extension[resource].extension[resource].valueReference = Reference(StructureDefinition/classification-profile)
...
* extension[section][14].extension[resource].extension[column][0].extension[header].valueString = "Grade"
* extension[section][14].extension[resource].extension[column][0].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/grade').valueCoding"
* extension[section][14].extension[resource].extension[column][1].extension[header].valueString = "Civil servant category"
* extension[section][14].extension[resource].extension[column][1].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/civil-servant-category').valueCoding"
* extension[section][14].extension[resource].extension[column][2].extension[header].valueString = "Contractual Category"
* extension[section][14].extension[resource].extension[column][2].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/contractual-category').valueCoding"
* extension[section][14].extension[resource].extension[column][3].extension[header].valueString = "Class"
* extension[section][14].extension[resource].extension[column][3].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/classification-class').valueCoding"
* extension[section][14].extension[resource].extension[column][4].extension[header].valueString = "Echelon"
* extension[section][14].extension[resource].extension[column][4].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/echelon').valueCoding"
...
* extension[section][14].extension[resource].extension[action][0].extension[link].valueString = "/questionnaire/classification/classification?practitioner=FHIRID"
* extension[section][14].extension[resource].extension[action][0].extension[text].valueString = "Add Classification"
...
* extension[section][14].extension[resource].extension[action][0].extension[task].valueId = "ihris-task-add-classification"
* extension[section][14].extension[resource].extension[action][1].extension[link].valueString = "/resource/view/classification/ITEMID"
...
* extension[section][14].extension[resource].extension[action][1].extension[task].valueId = "ihris-task-edit-classification"