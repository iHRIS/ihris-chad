...
* item[0].item[0].item[3].linkId = "Practitioner.name[0].extension[0]"
* item[0].item[0].item[3].definition = "http://ihris.org/fhir/StructureDefinition/ihris-practitioner#Practitioner.name.extension:civility.value[x]:valueCoding"
* item[0].item[0].item[3].text = "Civility"
* item[0].item[0].item[3].type = #choice
* item[0].item[0].item[3].answerValueSet = "http://ihris.org/fhir/ValueSet/civility-valueset"
...
* item[0].item[0].item[5].linkId = "Practitioner.photo"
* item[0].item[0].item[5].definition = "http://ihris.org/fhir/StructureDefinition/ihris-practitioner#Practitioner.photo"
* item[0].item[0].item[5].text = "Photo"
* item[0].item[0].item[5].type = #attachment
* item[0].item[0].item[5].required = true
* item[0].item[0].item[5].repeats = false

* item[0].item[1].linkId = "Practitioner.gender"
* item[0].item[1].definition = "http://ihris.org/fhir/StructureDefinition/ihris-practitioner#Practitioner.gender"
* item[0].item[1].text = "Gender"
* item[0].item[1].type = #choice
* item[0].item[1].answerValueSet = "http://ihris.org/fhir/ValueSet/td-gender-valueset"
* item[0].item[1].required = true
* item[0].item[1].repeats = false

* item[0].item[2].linkId = "Practitioner.extension[0]"
* item[0].item[2].definition = "http://ihris.org/fhir/StructureDefinition/ihris-practitioner#Practitioner.extension:marital-status.value[x]:valueCoding"
* item[0].item[2].text = "Marital Status"
* item[0].item[2].type = #choice
* item[0].item[2].answerValueSet = "http://ihris.org/fhir/ValueSet/marital-status-valueset"
...
* item[0].item[4].definition = "http://ihris.org/fhir/StructureDefinition/ihris-practitioner#Practitioner.extension:birth-place.value[x]:valueString"
* item[0].item[4].text = "Place of Birth"
...
* item[0].item[6].definition = "http://ihris.org/fhir/StructureDefinition/ihris-practitioner#Practitioner.extension:children.value[x]:valueInteger"
* item[0].item[6].text = "Number of Children"
