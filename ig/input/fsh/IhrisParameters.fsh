...
* parameter[=].valueSignature.data = "QjTTAU58+gA54ah3sZb35QqgwG3a1RrMsEbhwJjQMGJBwaLeMYw1wbLu3JqiwwpUmiXD2SWLj+anq3bl6IHP1Xhf//gP/05se6Rgm7LUQeYdG0HqSNpqdHts0bXVJ2cqAex/Z2WL4d9frmjylTdOke6lrjgR2xTN7vET6YGXgmg="
...
* parameter[=].part[=].valueString = "4"
* parameter[=].part[+].name = "site:nav:menu:database:menu:education:text"
* parameter[=].part[=].valueString = "Education Lists"
* parameter[=].part[+].name = "site:nav:menu:database:menu:education:color"
* parameter[=].part[=].valueString = "#B32317"
* parameter[=].part[+].name = "site:nav:menu:database:menu:education:order"
* parameter[=].part[=].valueString = "5"
* parameter[=].part[+].name = "site:nav:menu:database:menu:education:icon"
* parameter[=].part[=].valueString = "mdi-database"
* parameter[=].part[+].name = "site:nav:menu:database:menu:education:menu:qualification:text"
* parameter[=].part[=].valueString = "Qualification"
* parameter[=].part[+].name = "site:nav:menu:database:menu:education:menu:qualification:url"
* parameter[=].part[=].valueString = "/resource/search/qualification"
* parameter[=].part[+].name = "site:nav:menu:database:menu:education:menu:qualification:order"
* parameter[=].part[=].valueString = "0"
* parameter[=].part[+].name = "site:nav:menu:database:menu:education:menu:specialization:text"
* parameter[=].part[=].valueString = "Specialization"
* parameter[=].part[+].name = "site:nav:menu:database:menu:education:menu:specialization:url"
* parameter[=].part[=].valueString = "/resource/search/specialization"
* parameter[=].part[+].name = "site:nav:menu:database:menu:education:menu:specialization:order"
* parameter[=].part[=].valueString = "1"
* parameter[=].part[+].name = "site:nav:menu:database:menu:education:menu:education-type:text"
* parameter[=].part[=].valueString = "Education Type"
* parameter[=].part[+].name = "site:nav:menu:database:menu:education:menu:education-type:url"
* parameter[=].part[=].valueString = "/resource/search/education-type"
* parameter[=].part[+].name = "site:nav:menu:database:menu:education:menu:education-type:order"
* parameter[=].part[=].valueString = "2"
* parameter[=].part[+].name = "site:nav:menu:database:menu:education:menu:degree:text"
* parameter[=].part[=].valueString = "Degree"
* parameter[=].part[+].name = "site:nav:menu:database:menu:education:menu:degree:url"
* parameter[=].part[=].valueString = "/resource/search/degree"
* parameter[=].part[+].name = "site:nav:menu:database:menu:education:menu:degree:order"
* parameter[=].part[=].valueString = "3"
...
* parameter[=].part[=].valueString = "educationWorkflow"
