...
* parameter[=].valueSignature.data = "Tv6+6D/fPmi9QvB9o889jt0pr49u4lR7icT1WBxaTCYLoN4mAXzTzkjy1C39FiK7yIBP67aIx6fD5rafd/hLfKR9Cdch/Z4cMhmLTRJ2hKr0ZV1yDefws69cKFmfGB9h8hPHTL6IZOWJA8R+S3/yU/zBudNmUBCbNtaGBFudlqA="
...
* parameter[=].part[=].valueString = "/resource/search/country"
...
* parameter[=].part[+].name = "defaults:fields:Basic.extension:preservice-training.extension:degree.value[x]:valueReference:searchParameter"
* parameter[=].part[=].valueString = "educationtype"
* parameter[=].part[+].name = "defaults:fields:Basic.extension:preservice-training.extension:degree.value[x]:valueReference:type"
* parameter[=].part[=].valueString = "tree"
* parameter[=].part[+].name = "defaults:fields:Basic.extension:preservice-training.extension:degree.value[x]:valueReference:initialProfile"
* parameter[=].part[=].valueString = "http://ihris.org/fhir/StructureDefinition/td-education-type-profile"
