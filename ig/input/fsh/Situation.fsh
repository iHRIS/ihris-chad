...
* extension[section][0].extension[field][5].valueString = "Basic.extension:level"
* extension[section][0].extension[field][6].valueString = "Basic.extension:study-level"
* extension[section][0].extension[field][7].valueString = "Basic.extension:specialty"